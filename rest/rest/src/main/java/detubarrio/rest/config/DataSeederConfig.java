...
public class DataSeederConfig {
    ...
    public CommandLineRunner seedData(
        ...
        return args -> {
                        ensureAdminUser(usuarioRepository, passwordEncoder);
        ...
        private void ensureAdminUser(UsuarioRepository usuarioRepository, PasswordEncoder passwordEncoder) {
                Usuario admin = usuarioRepository.findByEmailIgnoreCase("admin@detubarrio.local")
                        .orElseGet(() -> Usuario.builder().email("admin@detubarrio.local").build());

                admin.setNombre("admin");
                admin.setEmail("admin@detubarrio.local");
