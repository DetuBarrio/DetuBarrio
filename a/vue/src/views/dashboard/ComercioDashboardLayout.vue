  ...
  <main class="dashboard-shell">
    <aside class="dashboard-sidebar shadow-sm">
      ...
      <nav class="sidebar-nav mt-3">
        <RouterLink to="/dashboard/comercio" class="sidebar-link" active-class="sidebar-link--active">
          <i class="bi bi-grid-1x2-fill me-2.5"></i> Panel general
        </RouterLink>
        
        <RouterLink to="/dashboard/comercio/reservas" class="sidebar-link" active-class="sidebar-link--active">
          <i class="bi bi-calendar-check-fill me-2.5"></i> Reservas
        </RouterLink>

        <RouterLink to="/dashboard/comercio/disponibilidad" class="sidebar-link" active-class="sidebar-link--active">
          <i class="bi bi-clock-fill me-2.5"></i> Horarios
        </RouterLink>

        <RouterLink to="/dashboard/comercio/clientes" class="sidebar-link" active-class="sidebar-link--active">
          <i class="bi bi-people-fill me-2.5"></i> Clientes
        </RouterLink>
        
        <RouterLink to="/dashboard/comercio/configuracion" class="sidebar-link" active-class="sidebar-link--active">
...
/* Enlaces del Navegador Lateral Sincronizados con tu Inspector */
.sidebar-nav {
  display: flex;
  flex-direction: column;
  gap: 0.35rem;
