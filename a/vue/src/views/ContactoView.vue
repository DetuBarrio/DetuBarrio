            ...
            <div class="row align-items-center g-4">
                ...
                <div class="col-lg-4">
                    <div class="glass-panel rounded-4 p-4 shadow-lg">
                        ...
                        <p class="mb-0 fw-semibold text-white">dtubarrio@gmail.com</p>
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card h-100 border-0 shadow-sm rounded-4">
                        <div class="card-body p-4">
                            ...
                            <p class="mb-1 fw-semibold">dtubarrio@gmail.com</p>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card h-100 border-0 shadow-sm rounded-4">
                        <div class="card-body p-4">
                            ...
                            <p class="mb-1 fw-semibold">+34 654 825 710</p>
                ...
                <div class="col-md-6 col-xl-3">
                    <div class="card h-100 border-0 shadow-sm rounded-4">
                        <div class="card-body p-4">
                            ...
                            <p class="text-muted small mb-0">Camino los cortijillos, Loma Cabrera, 04120 Almeria.</p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 col-xl-3">
