...
public interface ComercioRepository extends JpaRepository<Comercio, Long> {
    ...
    Page<Comercio> findByEstadoAndGestionAutorizadaTrue(EstadoComercio estado, Pageable pageable);
    Page<Comercio> findByCategoriaIdAndEstadoAndGestionAutorizadaTrue(Long categoriaId, EstadoComercio estado, Pageable pageable);
}